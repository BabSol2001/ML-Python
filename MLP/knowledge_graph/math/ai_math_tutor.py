...
class SocraticMathTutor:
    ...
    def ask_socratic_step(self, title, question, target_expr, hints, validation_type="sympy"):
        """اجرای یک گام تعاملی با راهنمایی‌های ۳ لایه‌ای و لحن صبورانه"""
        print(f"\n============================================================")
        print(f"📌 {title}")
        print(f"============================================================")
        print(question)
    ...
    def run_pinn_verification_demo(self, user_final_expr):
        ...
        if confirm.lower() == 'y':
            # فراخوانی تابع آموزش از فایل pinn.py
            model = train_pinn()
            
            # ارزیابی خروجی مدل با پاسخ دقیق از فایل integration_test.py
            ...
            # فراخوانی پاسخ دقیق از فایل integration_test.py
