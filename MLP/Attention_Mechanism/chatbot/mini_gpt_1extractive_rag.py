...
print("--- اجرای چت‌بات مجهز به سیستم RAG (راهکار ۱: Extractive RAG) ---")
...
# ==========================================
# ۶. حلقه چت RAG تعاملی (تغییر یافته به Extractive RAG)
# ==========================================
print("=" * 50)
print("   چت‌بات Extractive RAG آماده پاسخ‌گویی بر اساس PDF است!")
print("=" * 50 + "\n")
...
while True:
    try:
        ...
        # ۳. در راهکار ۱ (Extractive RAG):
        # به جای عبور دادن context از متد model.generate، متن بازیابی‌شده مستقیم استفاده می‌شود.
        answer_only_en = relevant_context_en

        # ۴. ترجمه و نمایش پاسخ اصلی استخراج‌شده از کتاب
        answer_fa = translator.en_to_fa(answer_only_en)
        
        print(f"\nچت‌بات (پاسخ استخراج‌شده از کتاب به انگلیسی):\n{answer_only_en}\n")
